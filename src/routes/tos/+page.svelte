<div class="container grid h-full gap-3 py-8">
  ...
  <h2 class="text-2xl font-semibold">Interpretation and Definitions</h2>
  ...
  <ul class="ml-6 list-disc">
    ...
    <li class="mt-2">
      <p>
        ...
        in this Agreement) refers to Deep Trading.
      </p>
    </li>
    <li class="mt-2">
    ...
    <li class="mt-2">
      <p>
        <strong>Website</strong> refers to Deep Trading, accessible from
        <a
          class="text-muted-foreground underline underline-offset-4 hover:text-primary"
          href="https://deep-trading.bbordes.fr"
          rel="external nofollow noopener"
          target="_blank">https://deep-trading.bbordes.fr</a
        >
      </p>
    </li>
    <li class="mt-2">
  ...
  <h2 class="text-2xl font-semibold">Acknowledgment</h2>
  <p>
    These are the Terms of Service governing the use of this Service and the agreement that operates between You and the
    Company. These Terms of Service set out the rights and obligations of all users regarding the use of the Service.
  </p>
  <p>
    Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and
    Conditions. These Terms of Service apply to all visitors, users and others who access or use the Service.
  </p>
  <p>
  ...
  <h2 class="text-2xl font-semibold">Links to Other Websites</h2>
  <p>
  ...
  <h2 class="text-2xl font-semibold">Termination</h2>
  <p>
  ...
  <h2 class="text-2xl font-semibold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
  <p>
  ...
  <h2 class="text-2xl font-semibold">Disputes Resolution</h2>
  <p>
    If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by
    contacting the Company.
  </p>
  <h2 class="text-2xl font-semibold">For European Union (EU) Users</h2>
  <p>
  ...
  <h2 class="text-2xl font-semibold">United States Legal Compliance</h2>
  <p>
  ...
  <h2 class="text-2xl font-semibold">Severability and Waiver</h2>
  <h3 class="text-xl font-semibold">Severability</h3>
  <p>
  ...
  <h3 class="text-xl font-semibold">Waiver</h3>
  <p>
  ...
  <h2 class="text-2xl font-semibold">Translation Interpretation</h2>
  <p>
    These Terms of Service may have been translated if We have made them available to You on our Service. You agree that
    the original English text shall prevail in the case of a dispute.
  </p>
  <h2 class="text-2xl font-semibold">Changes to These Terms of Service</h2>
  <p>
